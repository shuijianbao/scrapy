...
if __name__ == "__main__":
    ...
    http://quotes.money.163.com/service/zycwzb_601939.html?type=report


基于文本挖掘的社交网络情感与上市公司业绩关系研究
#hsRank > div.ID_tabs.clearfix > div.tabs-pane.pane-border.current > div > div.panelscroll-v > div.panelscroll-h > div.viewport > div > div > table.ID_table.stocks-info-table > tbody > tr:nth-child(1) > td.symbol > div > a.symbol
#hsRank > div.ID_tabs.clearfix > div.tabs-pane.pane-border.current > div > div.panelscroll-v > div.panelscroll-h > div.viewport > div > div > table.ID_table.stocks-info-table > tbody > tr:nth-child(2) > td.symbol > div > a.symbol
